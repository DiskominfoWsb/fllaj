<div class="box">
    ...
    <form id="multiform_add" method="POST" enctype="multipart/form-data">
        ...
        <div class="row form-group">
            ...
            <div class="col-md-10">
                <input data-validation="required" data-validation-error-msg="Silahkan isi Kegiatan" name="kegiatan" type="text" class="form-control" id="kegiatan" value="{$data.kegiatan}" />
            </div>
        </div>
        <div class="row form-group">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <input type="number" name="anggaran" class="form-control" value="{$data.anggaran}">
            </div>
        </div>
        <div class="row form-group">
            <div class="col-md-2">
            ...
            <div class="col-md-10">
                <input type="number" name="realisasi" class="form-control" value="{$data.realisasi}">
            </div>
        </div>
        <div class="row form-group">
            {for $foo=0 to 11}
                ...
                <div class="col-md-2">
                    <input type="number" name="data[{$foo}]" class="form-control" value="{$json[$foo]}">
                </div>
            {/for}
        </div>
