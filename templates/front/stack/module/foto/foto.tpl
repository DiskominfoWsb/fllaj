...
{foreach from=$arr_data item=r}
    ...
    {/if}
		<div class="col-md-4">
			<figure class="card card-img-top border-grey border-lighten-2" itemprop="associatedMedia" itemscope itemtype="//schema.org/ImageObject" onclick="preview('{$r.gambar}');" style="cursor: pointer;">
