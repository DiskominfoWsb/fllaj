(function ($) {
    ...
    var ajaxurl = minimal_photography_admin.ajax_url;
    var MinimalPhotographyNonce = minimal_photography_admin.ajax_nonce;
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: minimal_photography_admin.upload_image,
            button: {
            text: minimal_photography_admin.use_imahe
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'minimal_photography_notice_dismiss',
            '_wpnonce': MinimalPhotographyNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-minimal-photography-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-minimal-photography-notice').addClass('twp-installing');

        var data = {
            'action': 'minimal_photography_install_plugins',
            '_wpnonce': MinimalPhotographyNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = minimal_photography_admin.active
            var deactivate = minimal_photography_admin.deactivate
