...
if ( !function_exists('minimal_photography_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function minimal_photography_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('Minimal_Photography_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'minimal_photography_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('Minimal_Photography_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class Minimal_Photography_Tab_Posts_Widget extends Minimal_Photography_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'minimal_photography_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'minimal-photography'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'minimal-photography'),
                    'type'           => 'heading',
                ),
                'popular_post_title' => array(
                    'label'         => esc_html__('Popular Posts Title', 'minimal-photography'),
                    'type'          => 'text',
                    'default'          => esc_html__('Popular', 'minimal-photography'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'minimal-photography'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'select_image_size' => array(
                    'label' => esc_html__('Select Image Size Featured Post:', 'minimal-photography'),
                    'type' => 'select',
                    'default' => 'medium',
                    'options' => array(
                        'thumbnail' => esc_html__('Thumbnail', 'minimal-photography'),
                        'medium' => esc_html__( 'Medium', 'minimal-photography' ),
                        'large' => esc_html__( 'Large', 'minimal-photography' ),
                        'full' => esc_html__( 'Full', 'minimal-photography' ),
                        ),
                    
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'minimal-photography'),
                    'description'   => esc_html__('Number of words', 'minimal-photography'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'minimal-photography'),
                    'type'          => 'heading',
                ),
                'recent_post_title' => array(
                    'label'         => esc_html__('Recent Posts Title', 'minimal-photography'),
                    'type'          => 'text',
                    'default'          => esc_html__('Recent', 'minimal-photography'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'minimal-photography'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'minimal-photography'),
                    'type'            => 'heading',
                ),
                'comments_post_title' => array(
                    'label'         => esc_html__('Comments Posts Title', 'minimal-photography'),
                    'type'          => 'text',
                    'default'          => esc_html__('Comments', 'minimal-photography'),
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'minimal-photography'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'minimal-photography-tabbed', esc_html__( 'MP: Tab Posts Widget', 'minimal-photography' ), $opts, array(), $fields );
                        ...
                        <li tab-data="tab-popular" class="tab tab-popular active">
                            <a href="javascript:void(0)">
                                ...
                                <span class="fire-icon tab-icon">
                                    <?php minimal_photography_the_theme_svg('popular'); ?>
                                </span>
                        ...
                        <li tab-data="tab-recent" class="tab tab-recent">
                            <a href="javascript:void(0)">
                                ...
                                <span class="flash-icon tab-icon">
                                    <?php minimal_photography_the_theme_svg('flash'); ?>
                                </span>
                        ...
                        <li tab-data="tab-comments" class="tab tab-comments">
                            <a href="javascript:void(0)">
                                ...
                                <span class="comment-icon tab-icon">
                                    <?php minimal_photography_the_theme_svg('comment-2'); ?>
                                </span>
