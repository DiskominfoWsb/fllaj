 ...
 */
if ( !function_exists('minimal_photography_category_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function minimal_photography_category_widgets(){
        // Recent Post widget.
        register_widget('Minimal_Photography_Sidebar_Category_Widget');
    }
endif;
add_action('widgets_init', 'minimal_photography_category_widgets');
// Recent Post widget
if ( !class_exists('Minimal_Photography_Sidebar_Category_Widget') ) :
    /**
     * Recent Post.
     *
     * @since 1.0.0
     */
    class Minimal_Photography_Sidebar_Category_Widget extends Minimal_Photography_Widget_Base
    {
        /**
        ...
        {
            $opts = array(
                'classname' => 'minimal_photography_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'minimal-photography'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'minimal-photography'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'minimal-photography'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_label' => array(
                    'label'         => esc_html__('Latest Label', 'minimal-photography'),
                    'type'          => 'text',
                    'default'          => esc_html__('Latest:', 'minimal-photography'),
                ),
            );
            parent::__construct('minimal-photography-category-layout', esc_html__('MP: Category Widget', 'minimal-photography'), $opts, array(), $fields);
        }
        /**
